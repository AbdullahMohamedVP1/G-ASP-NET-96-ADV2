...
namespace AssigmentADV2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ProductSearcher.PrintProducts(ProductSearcher.SearchProducts(catalog, p => p.Category == "Electronics"));
            Console.WriteLine();

            Console.WriteLine("--- Under 50 ---");
            ProductSearcher.PrintProducts(ProductSearcher.SearchProducts(catalog, p => p.Price < 50));
            Console.WriteLine();

            Console.WriteLine("--- In Stock ---");
            ProductSearcher.PrintProducts(ProductSearcher.SearchProducts(catalog, p => p.Stock > 0));
            Console.WriteLine();
